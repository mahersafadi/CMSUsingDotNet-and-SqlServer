<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OffersList.aspx.cs" Inherits="bnp_OffersList" %>
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td width="60%" valign="top">
                                    <table width="100%">    
									<tr><td valign="top">
                                                <ul style="margin:0 !important" class="nav navbar-nav">
                                                    <li>Sort By:</li>
                                                    <li class="dropdown" > 
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">About BNP <span class="caret"></span></a>
                                                        <ul class="dropdown-menu" role="menu">
                                                                <li><a href="/bnp/OffersList.aspx?sort=latest">Latest Offers</a></li>
                                                                <li class="divider"></li>
                                                                 <li><a href="/bnp/OffersList.aspx?sort=newest">Newest</a></li>
                                                           </ul>
                                                       </li>
                                                        <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">About BNP <span class="caret"></span></a>
                                                          <ul class="dropdown-menu scrollable-menu" role="menu">
                                                            ...
                                                            <%=jt.toSortableList("/bnp/OffersList.aspx?sort={id}") %>                                                            
                                                          </ul>
                                                        </li>
                                                       </ul>
                                                        </td></tr>
